...
describe('isPositionValid', function() {
  ...
  it('invalidates positions with negative values', function() {
    expect(isPositionValid([
     '000001111110000',
  	 '000001001110000',
  	 '000001001111100',
    ...
    expect(isPositionValid([
     ...
     expect(isPositionValid([
      '000001111110000',
   	  ...
   	  '000000111110000',
   	  '000000111110000',
   	  '000000011100000'], [[-1,6]])).toEqual(false);
      expect(isPositionValid([
       '1110000000',
    	 '1B11110000',
    	 '1111111110',
    	 '0111111111',
    	 '0000011X11',
    	 '0000001110'], [[2,-1]])).toEqual(false);
  });
  it('invalidates positions greater than board values', function() {
    expect(isPositionValid([
     '000001111110000',
  	 '000001001110000',
  	 '000001001111100',
  	 ...
  	 '000000111110000',
  	 '000000111110000',
  	 '000000011100000'], [[10,1],[11,1]])).toEqual(false);
    expect(isPositionValid([
     '00011111110000',
   	 '00011111110000',
   	 '11110000011100',
   	 ...
   	 '11100111111111',
   	 '000001X1001111',
   	 '00000111001111'], [[3,16],[3,17]])).toEqual(false);
     expect(isPositionValid([
      '000001111110000',
   	  '000001001110000',
   	  '000001001111100',
   	  ...
   	  '000000111110000',
   	  '000000111110000',
   	  '000000011100000'], [[10,6]])).toEqual(false);
      expect(isPositionValid([
       '1110000000',
    	 '1B11110000',
    	 '1111111110',
